...
export function LibraryClient({ allApps }: { allApps: App[] }) {
    ...
    <div style={{ maxWidth: 980, margin: '0 auto', padding: '0 16px 60px' }}>
      ...
      {savedApps.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '80px 0' }}>
          ...
          <p style={{ fontSize: 18, fontWeight: 600, color: '#9A928A', marginBottom: 8 }}>No saved apps yet</p>
          <p style={{ fontSize: 14, color: '#504840', marginBottom: 28 }}>Tap Get on any app to add it to your library</p>
          <Link href="/" style={{ padding: '12px 28px', borderRadius: 999, background: '#F37338', color: '#0A0908', fontSize: 15, fontWeight: 700, textDecoration: 'none' }}>
            Discover Apps
          </Link>
        </div>
      ) : (
